...
class CameraShield:
    ...
    def object_tracking(self, image:np.ndarray):
        ...
        #     self.vid_writer = cv2.VideoWriter('/home/lyh/work/depoly/PyPeriShield-feature/demo07.mp4', cv2.VideoWriter_fourcc(*"mp4v"), 25, (int(1080), int(1920)))
        # 初始化追踪器
        ...
        # logger.info("yolo11——tracking:{outputs}", )
        # if outputs[0] is not None: # NOTE yolov5
...
if __name__ == "__main__":
    ...
    multiprocessing.Process(target=cs.start, ).start()
